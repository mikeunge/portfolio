  ...
  const technologies = {
    ...
    backend: {
      ...
      skills: [
        ...
        { name: "Custom Go backend", level: 85 },
      ],
    },
    database: {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="max-w-2xl mx-auto">
            With a strong foundation in backend systems, DevOps, and modern web
            development, I bring a practical and well-rounded approach to
            building scalable, efficient, and reliable software solutions.
          </p>
        </motion.div>
      </div>
    </section>
